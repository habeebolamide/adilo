<template>
    <div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 float-right">
                    <div class="btn btn-info text-white"><i class="bi bi-camera-video pr-2" style="font-size: 20px;"></i>
                        New Request</div>
                    <div class="btn btn-danger text-white mx-3" data-toggle="modal" data-target="#Recording"> <span
        ...
        <div class="modal fade" id="Recording" tabindex="-1" role="dialog" aria-labelledby="RecordingLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="width: 430px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button class="btn submit mt-4" @click="startRecording">Start Recording</button>
                    </div>
                </div>
            </div>
        </div>
...
#toggle2:checked+label,#toggle3:checked+label {
    background-color: #0AD688;
    content: '>';
}

#toggle1:checked+label::before,
#toggle2:checked+label::before,#toggle3:checked+label::before {
